...
Purpose: emotional soundtrack draft for scene atmosphere`,
  audio:[
    {
      title:'Main Theme Draft',
      file:'audio/ulzhan-main-theme.mp3',
      note:'Used for testing the main emotional tone of the series.'
    },
    {
      title:'Dramatic Scene Mood',
      file:'audio/ulzhan-dramatic-scene.mp3',
      note:'Generated as a dramatic variation for emotionally tense scenes.'
    },
    {
      title:'Ambient Background Draft',
      file:'audio/ulzhan-ambient-background.mp3',
      note:'Used as a soft background reference for slower dialogue scenes.'
    }
  ],
  img1:'suno.png'
},
