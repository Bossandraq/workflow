...
const toolInfo={
  ...
  prompt:`Lyrics: (Author lyrics or Generated Lyrics)
  Styles: 90s hip-hop, hard 808s, church choir in the chorus, guitar solo
  Vocal Gender: Female
  Weirdness: 50%
  Style Influence: 50%`
  audio:[
...
Subject:
football player walking toward empty goalposts
...
Motion:
magnetic tape floating in slow motion
...
static composition`,
  ...
  kling:{
    ...
    prompt:`
Motion Control task:
Shot type: slow dolly-in to the subject
Start: wide, 2 meters
End: medium close-up`,
    img1:'kling.png',
  },
